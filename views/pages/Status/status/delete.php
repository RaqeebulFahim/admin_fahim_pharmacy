...
<form action="<?php echo $base_url?>/status/confirm_delete" method="post" class="form form-control">
    <input type="hidden" name="id" id="id" value="<?php echo $status->id?>" class="form form-control">
