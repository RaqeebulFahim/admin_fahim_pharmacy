...
// error_reporting(E_ALL);
  ...
  //$abc= purchaseDetail::find_details(52);
  // print_r( $abc);
...
<div class="invoice-container">
    ...
    <!-- supplier & Shipping Details (two columns) -->
    <section class="invoice-address">
        <div class="address-column">
            <h4>supplier Information</h4>
            <p><strong>Name:</strong> <?php echo supplier::find($purchase->supplier_id)->name ?></p>
            <p><strong>Address:</strong><?php echo supplier::find($purchase->supplier_id)->address ?></p>
            <p><strong>Phone:</strong> <?php echo supplier::find($purchase->supplier_id)->phone ?></p>
            <p><strong>Email:</strong> <?php echo supplier::find($purchase->supplier_id)->email ?></p>
        </div>
        <div class="address-column">
    ...
    <section class="invoice-body">
        ...
        <table class="invoice-table">
            ...
            <tbody>
                <?php 
                  $purchase_details= purchaseDetail::find_details($purchase->id);
        ...
        <section class="invoice-summary">
            ...
            <div class="summary-right">
                ...
                <!-- <p><strong>Tax (15%):</strong><?php //print_r( $purchase); //echo $purchase->vat ?> BDT</p> -->
                <p><strong>Total Amount:</strong><?php echo $purchase->total_amount ?> BDT</p>
            </div>
        </section>
