                                ...
                                <div class="page-title-box">
                                    <h4>Dashboard</h4>
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Fahad Medical Store</a></li>
                                        ...
                                        <div class="inbox-wid">
                                            <a href="#" class="text-dark">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img float-start me-3"><img src="<?php echo $base_url?>/assets/images/users/user-1.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                            ...
                                            <a href="#" class="text-dark">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img float-start me-3"><img src="<?php echo $base_url?>/assets/images/users/user-2.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                            ...
                                            <a href="#" class="text-dark">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img float-start me-3"><img src="<?php echo $base_url?>/assets/images/users/user-3.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                            ...
                                            <a href="#" class="text-dark">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img float-start me-3"><img src="<?php echo $base_url?>/assets/images/users/user-4.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                            ...
                                            <a href="#" class="text-dark">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img float-start me-3"><img src="<?php echo $base_url?>/assets/images/users/user-5.jpg" class="avatar-sm rounded-circle" alt=""></div>
                                            ...
                                            <a href="#" class="text-dark">
                                                <div class="inbox-item">
                                                    <div class="inbox-item-img float-start me-3"><img src="<?php echo $base_url?>/assets/images/users/user-6.jpg" class="avatar-sm rounded-circle" alt=""></div>
